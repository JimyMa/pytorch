...
class DeviceMesh:
    ...
    def ndim(self) -> int:
        """
        Returns the number of dimensions in the mesh tensor of the current DeviceMesh.
        """
    ...
    def shape(self) -> Tuple[int, ...]:
        """
        Returns the shape of the mesh tensor of the current DeviceMesh.
        """
        return tuple(self.mesh.shape)

    def get_rank(self) -> int:
        """
        Returns the current global rank, which is the index of the rank relative to all
        devices in the current mesh.
        """
        return get_rank()
    ...
    def get_local_rank(
        ...
        """
        Returns the local rank of the given mesh_dim based on the given mesh_dim, or returns
        the local rank of a 1D DeviceMesh.

        .. note::
            User need to specify the mesh_dim when calling get_local_rank() on a DeviceMesh
